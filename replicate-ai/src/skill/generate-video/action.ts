/**
 * @typedef {Object} Input - Input parameters for video generation.
 * @property {string} prompt - Text description of the video to generate.
 * @property {string} [model] - Replicate model ID (defaults to "google/veo-3").
...
/**
 * @typedef {Object} Output - The output of the video generation.
 * @property {string} id - The prediction ID.
 * @property {string} status - The prediction status.
 * @property {any} output - The generated video URLs or data.
...
/**
 * Generate a video using an AI model on Replicate.
 *
 * @param {Input} input - The prompt, optional model, and optional extra parameters.
 *
 * @returns {Promise<Output>} The prediction result with generated video.
 */
