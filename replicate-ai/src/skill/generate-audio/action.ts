/**
 * @typedef {Object} Input - Input parameters for audio generation.
 * @property {string} prompt - Text prompt for music, or text content for speech.
 * @property {string} [model] - Replicate model ID (defaults to "minimax/music-2.5").
...
/**
 * @typedef {Object} Output - The output of the audio generation.
 * @property {string} id - The prediction ID.
 * @property {string} status - The prediction status.
 * @property {any} output - The generated audio URLs or data.
...
/**
 * Generate audio, music, or speech using an AI model on Replicate.
 *
 * @param {Input} input - The prompt, optional model, and optional extra parameters.
 *
 * @returns {Promise<Output>} The prediction result with generated audio.
 */
